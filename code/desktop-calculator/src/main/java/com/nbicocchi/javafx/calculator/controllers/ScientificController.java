...
public class ScientificController extends NormalController {
    ...
    public void buttonsFunctions() {
        ...
        btnExp.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "e^(" : "e^("));

        btnAbs.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "||" : "||"));

        btnFact.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "!" : "!"));
        ...
        btnLog.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "log(" : "log("));

        btnPow.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "^" : "^"));

        btnMod.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "%" : "%"));

        btnSqrt.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "sqrt(" : "sqrt("));

        btnPi.setOnAction(event -> txtShow.setText(txtShow.getText() != null ? txtShow.getText() + "π" : "π"));
    }
}
