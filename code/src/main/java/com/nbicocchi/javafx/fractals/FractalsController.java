...
public class FractalsController {
    ...
    private void applyZoom(double zoomFactor) {
        double xMinNew = complexArea.xMin - ((complexArea.getWidth() * zoomFactor) - complexArea.getWidth()) / 2;
        double yMinNew = complexArea.yMin - ((complexArea.getHeight() * zoomFactor) - complexArea.getHeight()) / 2;
